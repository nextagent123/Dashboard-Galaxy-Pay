...
export const NAV_SECTIONS = [
  ...
  },
  {
    header: "BÁO CÁO",
    items: [
      { href: "/thang", label: "Báo cáo tháng", icon: ["M3 4.5h18v16H3z", "M3 9h18M8 2.5v4M16 2.5v4"] },
...
export const FEATURES = [
  ...
  { href: "/thang", title: "Báo cáo tháng", desc: "Kết quả từng tháng", iconBg: "rgba(251,191,36,0.14)", icon: ["M3 4.5h18v16H3z", "M3 9h18M8 2.5v4M16 2.5v4"] },
