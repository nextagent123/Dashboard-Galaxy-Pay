...
// ---- Sale Pipeline V2 — dữ liệu theo layout mới (CRR → Gap → Projects) ----
export const PIPELINE_V2 = [
  {
    key: "gmv",
    label: "GMV",
    color: "#e11d48",        // red accent matching the screenshot
    barColor: "#7c6cff",     // purple bars for projects
    unit: "Tỷ",
    target: 25000,
    crr: 18000,
    prevYear: 13000,
    prevYearPct: 72,         // CRR vs Target (%)
    gap: 7000,
    projects: [
      { name: "DA. Topup chủ lực qua VCB & BIDV, MB", value: 9000, valueStr: "~9.000 Tỷ", kind: "Quy mô tiềm năng", isNew: false },
      { name: "DA. Payment Ecom - 2C2P", value: 765, valueStr: "765 Tỷ", kind: "Quy mô tiềm năng", isNew: true },
      { name: "DA. Payment DAM", value: 1275, valueStr: "1275 Tỷ", kind: "Quy mô tiềm năng", isNew: true },
      { name: "DA triển khai UPH cho Vikki & bán chéo từ HDFG", value: 1000, valueStr: "~1.000 Tỷ", kind: "Quy mô đóng góp", isNew: false },
    ],
  },
  {
    key: "dt",
    ...
    gap: 105,
    projects: [
      { name: "Dự án Cybs — Cổng TT quốc tế", value: 20, valueStr: "~20 Tỷ", kind: "Quy mô tiềm năng", isNew: false },
      { name: "Payment Hub QT (Smartro, Alipay, PayU…)", value: 8.711, valueStr: "~8,7 Tỷ", kind: "Quy mô đóng góp", isNew: false },
      { name: "Gói thầu thiết bị HDFG", value: 4.512, valueStr: "~4,5 Tỷ", kind: "Quy mô đóng góp", isNew: false },
      { name: "Dự án BHXH", value: 2, valueStr: "~2 Tỷ", kind: "Quy mô tiềm năng", isNew: true },
      { name: "Dự án OTA", value: 68, valueStr: "~68 Tỷ", kind: "Quy mô tiềm năng", isNew: false },
    ],
  },
  {
    key: "ln",
    ...
    gap: 14,
    projects: [
      { name: "Payment Hub VikkiBank", value: 12, valueStr: "~12 Tỷ", kind: "Quy mô tiềm năng", isNew: false },
      { name: "Các gói thầu HDFG", value: 0.5, valueStr: "~0,5 Tỷ", kind: "Quy mô đóng góp", isNew: false },
    ],
  },
];
