...
export const FALLBACK_ACT = {
  ...
  dt: [21.82, 17.23, 21.49, 15.51, 17.35, 21.002],
  ln: [5.52, 4.46, 6.0, 4.09, 4.9, 6.750],
};
...
export const KHOI = {
  ...
  dt: {
    ...
    act: [21.817, 17.233, 21.494, 15.514, 17.351, 21.002],
    peak: "linear-gradient(180deg,#6ee7b7,#34d399)",
    accent: "#6ee7b7",
  },
  ln: {
    ...
    act: [5.519, 4.463, 5.996, 4.091, 4.905, 6.750],
    peak: "linear-gradient(180deg,#fcd34d,#f59e0b)",
    accent: "#fcd34d",
  },
  dv: {
...
export const PIPELINE_GROUPS = [
  {
    ...
    prevYear: 11330,
    monthsElapsed: 5,
    monthlyTargets: [1881.8, 1797.9, 2884.8, 1218.5, 1324.6],
    ...
    projects: [
      { name: "Dự án Topup VCB", target: 3900, goLive: "06/2026", status: "Miss Deadline", note: "Đã quá deadline T6 — cần đẩy sớm hoàn tất tích hợp & đưa vào production", source: "Topup ngân hàng", gmvContrib: 3900 },
      { name: "Dự án Topup MB", target: 1920, goLive: "08/2026", status: "Risk", note: "Có rủi ro trượt deadline T8 — cần kiểm soát tiến độ & hạn chế phụ thuộc phía MB", source: "Topup ngân hàng", gmvContrib: 1920 },
      { name: "Dự án Topup BIDV", target: 260, goLive: "09/2026", status: "On Processing", note: "Đang triển khai theo tiến độ, target đưa lên production T9", source: "Topup ngân hàng", gmvContrib: 260 },
      { name: "Dự án Topup Vietinbank", target: 2, goLive: "09/2026", status: "On Processing", note: "Giai đoạn đầu triển khai, mục tiêu doanh số nhỏ trong 2026", source: "Topup ngân hàng", gmvContrib: 2 },
      { name: "Dự án Payment Hub VikkiBank", target: 1000, goLive: "08/2026", status: "Risk", note: "Có rủi ro deadline T8 — cần đẩy nhanh phase 1 & phối hợp Vikki xử lý blocker", source: "Payment Hub", gmvContrib: 1000 },
    ],
  },
  {
    key: "dt",
    ...
    projects: [
      { name: "Dự án Cybs", target: 20, goLive: "08/2026", status: "Risk", note: "Rủi ro trượt deadline T8 — cần chốt sớm ký kết Cybs Vietcombank & lên production T8", source: "Cổng TT quốc tế", gmvContrib: 480 },
      { name: "Dự án Payment Hub (quốc tế)", target: 8.711, goLive: "08/2026", status: "Risk", note: "Rủi ro deadline T8 — nhiều đối tác (Smartro, Alipay, Azupay, PayU) cần đồng bộ", source: "Payment Hub QT", gmvContrib: 210 },
      { name: "Gói thầu thiết bị HDFG", target: 4.512, goLive: "09/2026", status: "On Processing", note: "Đang triển khai theo tiến độ, target chốt gói thầu T9", source: "Gói thầu thiết bị", gmvContrib: 95 },
      { name: "Dự án BHXH", target: 2, goLive: "05/2026", status: "Miss Deadline", note: "Đã quá deadline T5 — cần rà soát nguyên nhân & lập lại roadmap", source: "Dịch vụ BHXH", gmvContrib: 55 },
      { name: "Dự án OTA", target: 68, goLive: "05/2026", status: "On Processing", note: "Đã qua mốc T5 nhưng đang chạy tiếp — cần theo dõi doanh số & biên phí", source: "Dịch vụ OTA", gmvContrib: 2100 },
    ],
  },
  {
    key: "ln",
    ...
    projects: [
      { name: "Dự án Payment Hub VikkiBank", target: 12, goLive: "09/2026", status: "Risk", note: "Rủi ro deadline T9 — cần đẩy nhanh phase 1 để đảm bảo biên LN kỳ vọng", source: "Payment Hub", gmvContrib: 1000 },
      { name: "Dự án các gói thầu HDFG", target: 0.5, goLive: "08/2026", status: "On Processing", note: "Đang triển khai theo tiến độ, chốt gói thầu trong T8", source: "Gói thầu thiết bị", gmvContrib: 95 },
    ],
  },
];
...
export const PRODUCTS = [
  {
    ...
    weeks: [["12/6–18/6", 10.066, 211], ["19/6–25/6", 7.944, 193], ["26/6–2/7", 9.695, 200], ["3/7–9/7", 9.126, 207], ["10/7–16/7", 8.471, 208]],
    months: [["T1", 27.157, 503], ["T2", 22.207, 440], ["T3", 43.816, 807], ["T4", 32.221, 658], ["T5", 30.502, 688], ["T6", 38.766, 869], ["T7", 24.498, 540]],
  },
  {
    key: "topuphd", code: "HD", name: "Dự án Topup HDB Centralize", accent: "#2f5bff",
    weeks: [["12/6–18/6", 107.495, 421], ["19/6–25/6", 84.880, 351], ["26/6–2/7", 81.783, 348], ["3/7–9/7", 86.446, 346], ["10/7–16/7", 89.729, 355]],
    months: [["T1", 400.309, 1582], ["T2", 275.406, 1183], ["T3", 397.887, 1754], ["T4", 365.297, 1533], ["T5", 371.552, 1666], ["T6", 426.566, 1710], ["T7", 224.732, 929]],
  },
  {
    key: "fx", code: "FX", name: "Dự án Mua bán ngoại tệ", accent: "#0ea5e9",
    weeks: [["12/6–18/6", 0.325, 9], ["19/6–25/6", 0.418, 15], ["26/6–2/7", 1.345, 23], ["3/7–9/7", 0.789, 16], ["10/7–16/7", 0.188, 7]],
    months: [["T1", 35.243, 299], ["T2", 24.574, 211], ["T3", 66.921, 545], ["T4", 19.92, 262], ["T5", 4.575, 83], ["T6", 2.397, 68], ["T7", 1.613, 34]],
  },
  {
    key: "skypos", code: "SP", name: "Dự án SkyPOS", accent: "#f59e0b",
    weeks: [["12/6–18/6", 0.000486, 3], ["19/6–25/6", 0.01325, 10], ["26/6–2/7", 0.009051, 4], ["3/7–9/7", 0.000489, 2], ["10/7–16/7", 0.001654, 2]],
    months: [["T1", 0, 0], ["T2", 0.00005, 1], ["T3", 0.0001, 1], ["T4", 0, 0], ["T5", 0.00001, 1], ["T6", 0.023, 17], ["T7", 0.002, 4]],
  },
  {
    key: "softpos", code: "SF", name: "Dự án SoftPos by HDB", accent: "#22c55e",
    weeks: [["12/6–18/6", 0.545, 3], ["19/6–25/6", 0.041, 10], ["26/6–2/7", 0.498, 4], ["3/7–9/7", 0.100, 2], ["10/7–16/7", 0.065, 2]],
    months: [["T1", 0.347, 3], ["T2", 0.63, 7], ["T3", 0.685, 9], ["T4", 0.643, 5], ["T5", 0.733, 15], ["T6", 1.254, 16], ["T7", 0.166, 3]],
  },
  {
    key: "vjweb", code: "WB", name: "Dự án VJ WEB B2B", accent: "#ec4899",
    weeks: [["12/6–18/6", 0.067, 2], ["19/6–25/6", 0, 0], ["26/6–2/7", 0, 0], ["3/7–9/7", 0.052, 1], ["10/7–16/7", 0.379, 43]],
    months: [["T1", 0, 0], ["T2", 0, 0], ["T3", 0, 0], ["T4", 0, 0], ["T5", 0, 0], ["T6", 0.068, 3], ["T7", 0.431, 44]],
  },
  {
    key: "vjplink", code: "PL", name: "Dự án VJ Payment Link", accent: "#e11d48",
    weeks: [["12/6–18/6", 0.284, 187], ["19/6–25/6", 0.343, 173], ["26/6–2/7", 0.518, 127], ["3/7–9/7", 0.363, 145], ["10/7–16/7", 0.322, 168]],
    months: [["T1", 1.325, 821], ["T2", 1.135, 742], ["T3", 1.301, 708], ["T4", 0.67, 391], ["T5", 0.949, 438], ["T6", 1.303, 652], ["T7", 1.003, 383]],
  },
];

// ---- KPI cá nhân — nguồn sheet "KPI Theo BDM". GMV: tỷ VND, Rev/GP: triệu (trừ Hằng dùng tỷ) ----
export const KHOI_YTD = { gmv: 8646.31, rev: 114.41, gp: 31.72 }; // tỷ VND — lũy kế T1-T6/2026
...
export const BDM = [
  ...
  },
  {
    ...
    metrics: {
      ...
      rev: { unit: "tr", kpi: pad12([200, 200, 200, 1189, 859, 973, 1178, 1309, 1244, 1024, 1189, 1189]), actual: pad12([264, 163, 398, 778, 857, 777]) },
      gp: { unit: "tr", kpi: pad12([37, 50, 57, 625, 616, 585, 757, 821, 807, 639, 749, 750]), actual: pad12([48, 26, 95, 404, 458, 470]) },
    },
  },
  {
    ...
    metrics: {
      ...
      rev: { unit: "tỷ", kpi: pad12([20.1, 22.4, 23.7, 24.9, 21.7, 22.6, 23.0, 21.4, 19.6, 21.5, 23.1, 23.0]), actual: pad12([21.2, 17.0, 20.7, 14.7, 16.5, 20.2]) },
      gp: { unit: "tỷ", kpi: pad12([5.2, 4.5, 4.9, 4.5, 5.5, 5.6, 4.9, 6.0, 6.1, 6.4, 6.5, 6.7]), actual: pad12([5.2, 4.4, 5.6, 3.7, 4.4, 6.3]) },
    },
  },
];
...
// ============================================================================
// BÁO CÁO P&L THEO NHÓM SẢN PHẨM — Cổng thanh toán, SoftPOS, Loa thanh toán
// Số liệu triệu VND (trừ khi ghi chú khác). Dữ liệu T1–T7/2026.
// Cổng TT: tổng hợp từ PRODUCTS (Topup QR, Topup HD, FX, VJ WEB, VJ PLink)
// SoftPOS: từ PRODUCTS (SoftPos by HDB + SkyPOS)
// Loa TT: từ LOA_SOURCES (phân bổ theo tháng)
// ============================================================================
export const PNL_PRODUCTS = [
  {
    ...
    monthly: {
      gmv:      [464.034, 323.322, 509.925, 418.108, 407.578, 469.1,   252.277],
      revenue:  [13.92,   9.70,    15.30,   12.54,   12.23,   14.07,   7.57],
      cogs:     [10.44,   7.27,    11.47,   9.41,    9.17,    10.55,   5.68],
      grossProfit:[3.48,  2.43,    3.83,    3.13,    3.06,    3.52,    1.89],
      opex:     [1.80,    1.80,    1.80,    1.80,    1.80,    1.80,    1.80],
      netProfit:[1.68,    0.63,    2.03,    1.33,    1.26,    1.72,    0.09],
      merchants:[45,      48,      52,      55,      58,      63,      65],
      transactions: [1324, 1183, 2062, 1311, 1210, 1612, 961],
    },
    targets: {
      gmv: 8400,
      revenue: 252,
  ...
  },
  {
    ...
    description: "SoftPos by HDB, SkyPOS — thanh toán không tiếp xúc qua điện thoại",
    monthly: {
      gmv:      [0.347,  0.630,   0.685,   0.643,   0.733,   1.277,   0.168],
      revenue:  [0.052,  0.095,   0.103,   0.096,   0.110,   0.192,   0.025],
      cogs:     [0.035,  0.063,   0.068,   0.064,   0.073,   0.127,   0.017],
      grossProfit:[0.017, 0.032,  0.035,   0.032,   0.037,   0.065,   0.008],
      opex:     [0.15,   0.15,    0.15,    0.15,    0.15,    0.15,    0.15],
      netProfit:[-0.133, -0.118,  -0.115,  -0.118,  -0.113,  -0.085,  -0.142],
      merchants:[3,      7,       9,       5,       15,      33,      37],
      transactions: [6, 11, 10, 7, 16, 33, 6],
    },
    targets: {
      gmv: 120,
      revenue: 18,
  ...
  },
  {
    ...
    description: "Thiết bị loa thông báo thanh toán — bán sỉ/lẻ KHDN, KHCN, Vikki, SBH",
    monthly: {
      gmv:      [0,      0,       0,       0,       0,       0,       0],
      revenue:  [81.42,  84.87,   15.19,   6.21,    92.02,   185.31,  0],
      cogs:     [59.90,  62.43,   11.18,   4.57,    67.69,   136.30,  0],
      grossProfit:[10.31, 9.23,   0.79,    0.50,    12.12,   25.20,   0],
      opex:     [3.50,   3.50,    3.50,    3.50,    3.50,    3.50,    3.50],
      netProfit:[6.81,   5.73,    -2.71,   -3.00,   8.62,    21.70,   -3.50],
      merchants:[239,    123,     22,      7,       161,     247,     0],
      transactions: [239, 123, 22, 7, 161, 247, 0],
    },
    targets: {
      gmv: 0,
      revenue: 3697.65,
