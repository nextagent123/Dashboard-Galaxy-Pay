...
// ---- Báo cáo Dịch vụ OTA ----
export const OTA_CUSTOMERS = [
  { name: "Vietjet Air", color: "#e11d48", slgd: [12500, 14200, 15100, 16800, 18200, 17500, 0, 0, 0, 0, 0, 0], gtgd: [42.5, 48.7, 52.3, 58.9, 64.2, 61.8, 0, 0, 0, 0, 0, 0] },
  { name: "SkyJoy", color: "#f59e0b", slgd: [3200, 3450, 3600, 3850, 4100, 4250, 0, 0, 0, 0, 0, 0], gtgd: [8.2, 9.1, 9.6, 10.5, 11.4, 12.1, 0, 0, 0, 0, 0, 0] },
  { name: "SkyFi", color: "#7c6cff", slgd: [1850, 2010, 2200, 2400, 2550, 2700, 0, 0, 0, 0, 0, 0], gtgd: [3.8, 4.1, 4.5, 5.0, 5.4, 5.8, 0, 0, 0, 0, 0, 0] },
  { name: "VNPAY OTA", color: "#34d399", slgd: [980, 1050, 1180, 1250, 1320, 1400, 0, 0, 0, 0, 0, 0], gtgd: [1.8, 2.0, 2.3, 2.5, 2.7, 2.9, 0, 0, 0, 0, 0, 0] },
  { name: "IMediaOTA", color: "#0ea5e9", slgd: [520, 580, 610, 690, 720, 780, 0, 0, 0, 0, 0, 0], gtgd: [0.8, 0.9, 1.0, 1.2, 1.3, 1.4, 0, 0, 0, 0, 0, 0] },
];
