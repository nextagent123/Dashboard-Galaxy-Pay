...
export const BDM = [
  ...
  {
    name: "Phạm Thị Thúy Hằng", role: "BDM Senior · Phòng Kinh doanh", accent: "#34d399", short: "PTH",
    metrics: {
...
// ---- Sky Partner Platform ----
export const SKY_PARTNER_BLOCKS = [
  { id: 1, name: "Công ích & DVC", color: "#378ADD", items: ["Điện, nước, internet", "DVC C06, VETC", "Học phí, chung cư"], rev: "Flat fee 1–7K/GD" },
  { id: 2, name: "Voucher & vé", color: "#1D9E75", items: ["Vé Vietjet NĐ & QT", "Vé tàu, xe, sự kiện", "eVoucher, SkyJoy"], rev: "HH 1.5–15% TPV" },
  { id: 3, name: "eCommerce & O2O", color: "#D85A30", items: ["BH TNDS, tai nạn", "BH du lịch quốc tế", "Bán chéo POS xăng"], rev: "HH đại lý 10–35%" },
  { id: 4, name: "Tài chính nhúng & QT", color: "#D4537E", items: ["Mở TK/thẻ HDBank", "Vay trả góp vé", "QR cross-border"], rev: "Referral + FX" },
  { id: 5, name: "Tiện ích số & telco", color: "#534AB7", items: ["Topup, thẻ cào, data", "SIM & eSIM du lịch", "Thẻ game, content"], rev: "CK 3–30% mệnh giá" },
  { id: 6, name: "HST độc quyền Sovico", color: "#639922", items: ["Starlink WiFi Vietjet", "Phí cư dân Phú Long", "Đặc quyền CĐ & CBNV"], rev: "Platform fee" },
];

export const SKY_PARTNER_PHASE1 = [
  { stt: 1, name: "Hóa đơn Điện (EVN)", baseline: 41780, factor: 2.5, gdMonth: 104450, avgValue: 935000, fee: "400đ/GD", feeType: "fixed", source: "iMedia T7/2026", dtThangCautious: 29246000, dtThangBase: 41780000, dtThangOptimistic: 58492000, dt2Month: 83560000, dtYear1: 722794000, block: 1 },
  { stt: 2, name: "Hóa đơn Nước (245+ NCC)", baseline: 5068, factor: 2, gdMonth: 10136, avgValue: 214000, fee: "400đ/GD", feeType: "fixed", source: "iMedia T7/2026", dtThangCautious: 2838080, dtThangBase: 4054400, dtThangOptimistic: 5676160, dt2Month: 8108800, dtYear1: 70141120, block: 1 },
  { stt: 3, name: "Internet (FPT)", baseline: 2900, factor: 2, gdMonth: 5800, avgValue: 280000, fee: "400đ/GD", feeType: "fixed", source: "iMedia T7/2026", dtThangCautious: 1624000, dtThangBase: 2320000, dtThangOptimistic: 3248000, dt2Month: 4640000, dtYear1: 40136000, block: 1 },
  { stt: 4, name: "Truyền hình (K+, VTC, MobiTV)", baseline: 2908, factor: 2, gdMonth: 5816, avgValue: 260000, fee: "400đ/GD", feeType: "fixed", source: "iMedia T7/2026", dtThangCautious: 1628480, dtThangBase: 2326400, dtThangOptimistic: 3256960, dt2Month: 4652800, dtYear1: 40246720, block: 1 },
  { stt: 5, name: "Lệ phí DVC C06", baseline: 0, factor: 1, gdMonth: 5000, avgValue: 150000, fee: "3.000đ/GD", feeType: "fixed", source: "Benchmark TT", dtThangCautious: 10500000, dtThangBase: 15000000, dtThangOptimistic: 21000000, dt2Month: 30000000, dtYear1: 259500000, block: 1 },
  { stt: 6, name: "Nạp VETC / ePass", baseline: 2917, factor: 3, gdMonth: 8751, avgValue: 300000, fee: "2.000đ/GD", feeType: "fixed", source: "Benchmark TT", dtThangCautious: 12251400, dtThangBase: 17502000, dtThangOptimistic: 24502800, dt2Month: 35004000, dtYear1: 302784600, block: 1 },
  { stt: 7, name: "Học phí", baseline: 0, factor: 1, gdMonth: 2000, avgValue: 3000000, fee: "1.000đ/GD", feeType: "fixed", source: "iMedia T7/2026", dtThangCautious: 1400000, dtThangBase: 2000000, dtThangOptimistic: 2800000, dt2Month: 4000000, dtYear1: 34600000, block: 1 },
  // Postpaid: phí tính theo %GTGD từ Imedia (Viettel 0.5%, MobiFone 0.4%, VinaPhone 0.4%). Bình quân gia quyền ~0.45%
  { stt: 8, name: "Nạp tiền ĐT trả sau (Postpaid)", baseline: 4209, factor: 2, gdMonth: 8418, avgValue: 190000, fee: "~0.45%/GTGD", feeType: "percent", source: "Imedia T7/2026",
    dtThangCautious: 5038173, dtThangBase: 7197390, dtThangOptimistic: 10076346, dt2Month: 14394780, dtYear1: 124514847, block: 1,
    postpaidCarriers: [
      { carrier: "Viettel",   share: 0.50, ck: 0.5, gdMonth: 4209, dtBase: 3998550 },
      { carrier: "MobiFone",  share: 0.25, ck: 0.4, gdMonth: 2105, dtBase: 1599800 },
      { carrier: "VinaPhone", share: 0.25, ck: 0.4, gdMonth: 2104, dtBase: 1599040 },
    ],
  },
  // Thanh toán khoản vay (19 NCC): phí Imedia T7/2026 từ 3,000–7,000đ/GD. Bình quân gia quyền ~4,250đ/GD
  // Ước tính share: FE/Home/HDS/Shinhan 45% @3k, Mirae 5% @4k, VPBank/VIB/OCB/MSB/TCB/MB+5 40% @5k, JACCS 10% @7k
  { stt: 18, name: "Thanh toán khoản vay (19 NCC)", baseline: 708, factor: 2, gdMonth: 1416, avgValue: 1650000, fee: "~4.250đ/GD", feeType: "fixed", source: "Imedia T7/2026",
    dtThangCautious: 4212600, dtThangBase: 6018000, dtThangOptimistic: 8425200, dt2Month: 12036000, dtYear1: 104111400, block: 1,
    loanProviders: [
      { group: "FE Credit / Home Credit / HD Saison / Shinhan", share: 0.45, fee: 3000, gdMonth: 637, dtBase: 1911000 },
      { group: "Mirae Asset",                                   share: 0.05, fee: 4000, gdMonth: 71,  dtBase: 284000 },
      { group: "VPBank / VIB / OCB / MSB / Techcombank / MB +5",share: 0.40, fee: 5000, gdMonth: 566, dtBase: 2830000 },
      { group: "JACCS",                                         share: 0.10, fee: 7000, gdMonth: 142, dtBase: 994000 },
    ],
  },
  { stt: 9, name: "Vé Vietjet Air (NĐ + QT)", baseline: 0, factor: 1, gdMonth: 8000, avgValue: 1800000, fee: "20.000đ/vé", feeType: "fixed", source: "iMedia T7/2026", dtThangCautious: 112000000, dtThangBase: 160000000, dtThangOptimistic: 224000000, dt2Month: 320000000, dtYear1: 2768000000, block: 2 },
  { stt: 10, name: "BH TNDS Xe máy (bắt buộc)", baseline: 0, factor: 1, gdMonth: 15000, avgValue: 66000, fee: "20% HH", feeType: "percent", source: "HD Insurance", dtThangCautious: 138600000, dtThangBase: 198000000, dtThangOptimistic: 277200000, dt2Month: 396000000, dtYear1: 3425400000, block: 3 },
  { stt: 11, name: "BH TNDS Ô tô (bắt buộc)", baseline: 0, factor: 1, gdMonth: 3000, avgValue: 480000, fee: "15% HH", feeType: "percent", source: "Benchmark TT", dtThangCautious: 151200000, dtThangBase: 216000000, dtThangOptimistic: 302400000, dt2Month: 432000000, dtYear1: 3736800000, block: 3 },
  { stt: 12, name: "BH Tai nạn cá nhân", baseline: 0, factor: 1, gdMonth: 5000, avgValue: 120000, fee: "25% HH", feeType: "percent", source: "HD Insurance", dtThangCautious: 105000000, dtThangBase: 150000000, dtThangOptimistic: 210000000, dt2Month: 300000000, dtYear1: 2595000000, block: 3 },
  { stt: 13, name: "BH Trễ chuyến máy bay", baseline: 0, factor: 1, gdMonth: 2000, avgValue: 150000, fee: "20% HH", feeType: "percent", source: "iMedia T7/2026", dtThangCautious: 42000000, dtThangBase: 60000000, dtThangOptimistic: 84000000, dt2Month: 120000000, dtYear1: 1038000000, block: 3 },
  // Topup: CK bình quân gia quyền ~4.07% từ Imedia (Viettel 3.6% ×50%, VinaPhone 4.6% ×22%, MobiFone 3.7% ×20%, Vietnamobile 6.5% ×8%)
  { stt: 14, name: "Nạp tiền ĐT trả trước (Topup)", baseline: 79455, factor: 2, gdMonth: 158910, avgValue: 63000, fee: "~4.07% CK", feeType: "percent", source: "Imedia",
    dtThangCautious: 285363118, dtThangBase: 407661597, dtThangOptimistic: 570726236, dt2Month: 815323194, dtYear1: 7052545628, block: 5,
    topupCarriers: [
      { carrier: "Viettel",      share: 0.50, ck: 3.6, gdMonth: 79455, dtBase: 180203940 },
      { carrier: "VinaPhone",    share: 0.22, ck: 4.6, gdMonth: 34960, dtBase: 101314080 },
      { carrier: "MobiFone",     share: 0.20, ck: 3.7, gdMonth: 31782, dtBase: 74083842 },
      { carrier: "Vietnamobile", share: 0.08, ck: 6.5, gdMonth: 12713, dtBase: 52059735 },
    ],
  },
  { stt: 15, name: "Thẻ cào / Gói dữ liệu", baseline: 445, factor: 3, gdMonth: 1335, avgValue: 50000, fee: "~12% CK", feeType: "percent", source: "Imedia", dtThangCautious: 5607000, dtThangBase: 8010000, dtThangOptimistic: 11214000, dt2Month: 16020000, dtYear1: 138573000, block: 5,
    dataCardCarriers: [
      { carrier: "Viettel (Sponsor)", share: 0.50, ck: 10.0, gdMonth: 668, dtBase: 3340000 },
      { carrier: "VinaPhone", share: 0.25, ck: 14.0, gdMonth: 334, dtBase: 2338000 },
      { carrier: "MobiFone (Thông thường)", share: 0.15, ck: 17.0, gdMonth: 200, dtBase: 1700000 },
      { carrier: "MobiFone (DC_ON)", share: 0.10, ck: 10.0, gdMonth: 134, dtBase: 670000 },
    ],
  },
  { stt: 16, name: "SIM / eSIM du lịch", baseline: 0, factor: 1, gdMonth: 3000, avgValue: 200000, fee: "15% CK", feeType: "percent", source: "Galaxy Telecom", dtThangCautious: 63000000, dtThangBase: 90000000, dtThangOptimistic: 126000000, dt2Month: 180000000, dtYear1: 1557000000, block: 5 },
  { stt: 17, name: "Vé xe khách (Vexere)", baseline: 0, factor: 1, gdMonth: 1500, avgValue: 350000, fee: "3% HH", feeType: "percent", source: "iMedia T7/2026", dtThangCautious: 11025000, dtThangBase: 15750000, dtThangOptimistic: 22050000, dt2Month: 31500000, dtYear1: 272475000, block: 2 },
];
