...
export const USERS = [
  ...
  { u: "tuyet", h: "200f528e2c19449c8f5dd9477a19f94f4233a4c632932cb2ab84fbf325921114", name: "Tuyết", role: "BDM", ini: "T" },
  { u: "dtlkhdbank", h: "8102444a45d2cab10db277522d44d35f1ba0629383e6b3630b6b9a350f415570", name: "Đối tác liên kết", role: "Phòng PT ĐTLK", ini: "ĐT" },
  { u: "haibui", h: "e9e4acd5bc6e472e5e86f2258d1bb5274007f8e94bc2d1be2ac5db19e37687e1", name: "Hải Bùi", role: "Head of Legal", ini: "HB" },
  { u: "dao", h: "498f38d2313e966b600df2da9ca45e64926dfc00da778516bb070520f694d6ed", name: "Dao", role: "Head of Product", ini: "D" },
];
export const ADMIN_USERS = ["taicv", "diem", "nhan"];

export const RESTRICTED_USERS = {
  dtlkhdbank: ["/khcn"],
  haibui: ["/", "/forex", "/stock"],
  dao: ["/", "/planning", "/psp", "/doi-tac", "/vendor", "/partner", "/sp", "/ota", "/bhxh", "/gd"],
};
