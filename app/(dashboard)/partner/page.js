    ...
    <>
      ...
      <div className="grid-2" style={{ marginBottom: 0 }}>
        <div className="card" style={{ borderTop: "3px solid var(--green)" }}>
          <h3 style={{ fontSize: 14, fontWeight: 600, color: "var(--green)", margin: 0, display: "flex", alignItems: "center", gap: 8 }}>
            🏢 Sovico Ecosystem
          </h3>
          <p style={{ fontSize: 12, color: "var(--text-dim)", margin: "8px 0 0", lineHeight: 1.6 }}>
            Vietjet Air, HDBank, Vikki, HD Insurance, Galaxy Telecom, Petrolimex, PV Oil, Phú Long
          </p>
        </div>
        <div className="card" style={{ borderTop: "3px solid var(--amber)" }}>
          <h3 style={{ fontSize: 14, fontWeight: 600, color: "var(--amber)", margin: 0, display: "flex", alignItems: "center", gap: 8 }}>
            🌍 External Partners
          </h3>
          <p style={{ fontSize: 12, color: "var(--text-dim)", margin: "8px 0 0", lineHeight: 1.6 }}>
            iMedia, Vexere, Got It, Urbox, EVN, VETC, C06, Starlink, eSIM Go
          </p>
        </div>
      </div>

      {/* Arrow */}
      <div style={{ textAlign: "center", color: "var(--text-faint)", fontSize: 20, margin: "6px 0", letterSpacing: 12 }}>▼ ▼ ▼</div>

      {/* Core Platform */}
      <div className="card" style={{
        textAlign: "center", padding: "20px 24px",
        background: "linear-gradient(135deg, rgba(124,108,255,0.12), rgba(157,139,255,0.06))",
        border: "1px solid rgba(124,108,255,0.25)",
      }}>
        <h2 style={{ fontSize: 18, fontWeight: 700, color: "var(--accent-2)", margin: 0 }}>
          ⚙️ Sky Partner Platform
        </h2>
        <p style={{ fontSize: 12, color: "var(--text-dim)", margin: "6px 0 0" }}>
          Invisible back-end orchestrator · Galaxy Pay · PaaS · API gateway · split settlement · auto-recon
        </p>
      </div>
          ...
          <div key={b.id} className="card" style={{ padding: 0, overflow: "hidden" }}>
            ...
            <div style={{ padding: "16px 20px" }}>
              <span style={{
                ...
                padding: "2px 10px", borderRadius: 4, marginBottom: 10,
                background: `${b.color}18`, color: b.color,
              }}>0{b.id}</span>
              <h3 style={{ fontSize: 15, fontWeight: 600, color: "var(--text)", margin: "0 0 10px" }}>{b.name}</h3>
              <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                {b.items.map((item, i) => (
                  <li key={i} style={{ fontSize: 12, color: "var(--text-dim)", padding: "3px 0", display: "flex", alignItems: "center", gap: 6 }}>
              ...
              <div style={{
                marginTop: 12, paddingTop: 10, borderTop: "1px solid var(--border-faint)",
      ...
      <div className="grid-2" style={{ marginBottom: 0 }}>
        <div className="card">
          <h3 style={{ fontSize: 14, fontWeight: 600, color: "var(--text)", margin: "0 0 6px", display: "flex", alignItems: "center", gap: 8 }}>📱 Digital</h3>
          <p style={{ fontSize: 12, color: "var(--text-dim)", lineHeight: 1.6, margin: 0 }}>Vietjet App, SkyJoy, HDBank, Vikki, Trạm công dân số</p>
        </div>
        <div className="card">
          <h3 style={{ fontSize: 14, fontWeight: 600, color: "var(--text)", margin: "0 0 6px", display: "flex", alignItems: "center", gap: 8 }}>🏪 O2O Network</h3>
          <p style={{ fontSize: 12, color: "var(--text-dim)", lineHeight: 1.6, margin: 0 }}>~10.000 POS trạm xăng, chuỗi tiện lợi, siêu thị</p>
        </div>
      </div>

      <div style={{ textAlign: "center", color: "var(--text-faint)", fontSize: 20, margin: "6px 0" }}>▼</div>

      {/* End Users */}
      <div style={{ textAlign: "center", marginBottom: 16 }}>
        <div className="card" style={{ display: "inline-block", padding: "12px 32px", borderRadius: 24 }}>
          <span style={{ fontSize: 13, color: "var(--text-dim)" }}>👥 End users · B2C & B2B2C</span>
        </div>
      </div>
