  ...
  return (
    <>
      ...
      <PageHeader
        ...
        right={
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <DateBadge>Số liệu đến 05/08/2026</DateBadge>
          </div>
        }
      />
        ...
        {data.metrics.map((m) => (
          <KpiCardShell key={m.key} label={m.label} icon={<Icon paths={METRIC_ICON_PATHS[m.key]} />} iconBg={m.iconBg} glow={m.glow}>
            <div style={{ display: "flex", alignItems: "baseline", gap: 6, marginTop: 14, position: "relative" }}>
              ...
              <span style={{ fontSize: 13, color: "var(--text-dim)", fontWeight: 600 }}>{m.unit}</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 8, position: "relative" }}>
              ...
              <span style={{ fontSize: 11.5, color: "var(--text-faint)" }}>so với kỳ trước</span>
            </div>
      ...
      <section className="grid-home-split">
        <div className="card">
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
            <div>
              ...
              <div style={{ fontSize: 12, color: "var(--text-dim)", marginTop: 3 }}>Thực đạt lũy kế so với Target năm · vạch ▏ = Target H1</div>
            </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 6, marginTop: 14 }}>
            {data.targets.map((t) => (
              <div key={t.name} style={{ padding: "14px 0", borderTop: "1px solid var(--border-soft)" }}>
                <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: 12, marginBottom: 10 }}>
                  <span style={{ fontSize: 14, fontWeight: 700, color: "var(--text-strong)", whiteSpace: "nowrap", flexShrink: 0 }}>{t.name}</span>
                  <span style={{ fontSize: 12, color: "var(--text-dim)", whiteSpace: "nowrap" }}>
                    Thực đạt <b className="mono" style={{ color: "var(--text-strong)" }}>{t.actual}</b> / Năm <b className="mono" style={{ color: "var(--text)" }}>{t.year}</b>
                  </span>
                </div>
                <div style={{ position: "relative", height: 14, borderRadius: 8, background: "var(--surface-raised)", overflow: "hidden" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", marginTop: 9 }}>
                  <span style={{ fontSize: 11.5, color: "var(--text-dim)" }}>
                    Target H1: <b className="mono" style={{ color: "var(--text)" }}>{t.h1}</b> · Đạt H1 <b style={{ color: t.h1Color }}>{t.h1pct}</b>
                  </span>
                  <span className="mono" style={{ fontSize: 12.5, fontWeight: 800, color: "var(--accent-light)" }}>{t.yearPct} năm</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div
          style={{
            background: "linear-gradient(165deg, rgba(124,108,255,0.16), transparent)",
        ...
        >
          ...
          <div style={{ fontSize: 12, color: "var(--text-dim)", marginTop: 3 }}>Lũy kế T1–T7 vs Target H1 (bình quân GMV/DT/LN)</div>
          ...
          <div style={{ display: "inline-flex", alignSelf: "flex-start", alignItems: "center", gap: 5, fontSize: 12, fontWeight: 700, padding: "4px 10px", borderRadius: 8, color: "#fbbf24", background: "rgba(251,191,36,0.12)" }}>
            ↓ Chậm hơn tiến độ (đã qua 7/12 tháng)
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <span style={{ fontSize: 12.5, color: "var(--text-dim)" }}>Chỉ số bám tiến độ H1</span>
              <span className="mono" style={{ fontWeight: 700, color: "#fbbf24" }}>2 / 3</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <span style={{ fontSize: 12.5, color: "var(--text-dim)" }}>GMV lũy kế T1–T7</span>
              <span className="mono" style={{ fontWeight: 700 }}>{data.trendTotal}</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <span style={{ fontSize: 12.5, color: "var(--text-dim)" }}>Biên lợi nhuận gộp</span>
              <span className="mono" style={{ fontWeight: 700 }}>{data.marginPct}</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <span style={{ fontSize: 12.5, color: "var(--text-dim)" }}>Cần chú ý</span>
      ...
      <SectionCard
        ...
        right={
          <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
            ...
            <span style={{ fontSize: 12, color: "var(--text-dim)" }}>lũy kế T1–T7</span>
          </div>
        }
      >
        <div style={{ display: "flex", alignItems: "center", gap: 14, fontSize: 11.5, color: "var(--text-dim)", marginTop: 6, marginBottom: -8 }}>
          <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <span style={{ width: 10, height: 10, borderRadius: 3, background: "linear-gradient(180deg,#b98cff,#7c6cff)" }} />Thực đạt (T1–T7)
          </span>
          <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <span style={{ width: 10, height: 10, borderRadius: 3, background: "repeating-linear-gradient(135deg,var(--text-faintest),var(--text-faintest) 3px,transparent 3px,transparent 6px)" }} />Kế hoạch (T6–T12)
          </span>
          <span style={{ color: "var(--text-faint)" }}>Đơn vị: tỷ VND</span>
        </div>
      ...
      <section className="grid-2">
        <SectionCard
          ...
          right={
            <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
              ...
              <span style={{ fontSize: 11, color: "var(--text-dim)" }}>lũy kế T1–T7</span>
            </div>
          }
        >
          <div style={{ display: "flex", alignItems: "center", gap: 14, fontSize: 11.5, color: "var(--text-dim)", marginTop: 6, marginBottom: -6 }}>
            <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <span style={{ width: 10, height: 10, borderRadius: 3, background: "linear-gradient(180deg,#6ee7b7,#34d399)" }} />Thực đạt (T1–T7)
            </span>
            <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <span style={{ width: 10, height: 10, borderRadius: 3, background: "repeating-linear-gradient(135deg,var(--text-faintest),var(--text-faintest) 3px,transparent 3px,transparent 6px)" }} />Kế hoạch (T6–T12)
            </span>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 14, fontSize: 11.5, color: "var(--text-dim)", marginTop: 6, marginBottom: -6 }}>
            <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <span style={{ width: 10, height: 10, borderRadius: 3, background: "linear-gradient(180deg,#fcd34d,#f59e0b)" }} />Thực đạt (T1–T7)
            </span>
            <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <span style={{ width: 10, height: 10, borderRadius: 3, background: "repeating-linear-gradient(135deg,var(--text-faintest),var(--text-faintest) 3px,transparent 3px,transparent 6px)" }} />Kế hoạch (T6–T12)
            </span>
      ...
      <section>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
          ...
          <span style={{ fontSize: 12, color: "var(--text-dim)" }}>Truy cập nhanh</span>
        </div>
          ...
          {FEATURES.filter((f) => {
            ...
            <Link
              ...
              style={{
                ...
                borderRadius: 16, background: "var(--surface-soft)",
            ...
            >
              ...
              <div>
                <div style={{ fontSize: 14, fontWeight: 700, color: "var(--text-strong)" }}>{f.title}</div>
                <div style={{ fontSize: 12, color: "var(--text-dim)", marginTop: 4, lineHeight: 1.4 }}>{f.desc}</div>
              </div>
            </Link>
          ))}
        </div>
